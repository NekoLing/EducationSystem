        ...
        if(url != null){
            ...
            if(StringUtils.isNotBlank(token)){
                ...
                if(verify != 1){
                    ...
                    //验证身份
                    if (jwtUitls.getType(token) != MyConstant.ACCOUNT_TYPE_STUDENT && jwtUitls.getType(token) != MyConstant.ACCOUNT_TYPE_MANAGER) {
                        map.put("state", "3");
