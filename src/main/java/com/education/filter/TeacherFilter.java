 ...
 * @Description 教师账户的过滤器
 * @Date 2021/12/9 21:05
 * @Created by gaoqi
 */
@Order(2)
        ...
        if(url != null){
            ...
            if(StringUtils.isNotBlank(token)){
                ...
                if(verify != 1){
                    ...
                    //验证身份
                    if (jwtUitls.getType(token) != MyConstant.ACCOUNT_TYPE_TEACHER && jwtUitls.getType(token) != MyConstant.ACCOUNT_TYPE_MANAGER) {
                        map.put("state", "3");
